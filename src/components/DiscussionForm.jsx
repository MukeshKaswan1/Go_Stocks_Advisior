...
const DiscussionForm = ({isSidebar,sidebar}) => {
  return (
    <div className={`discussionSection w-[60%] max-md:w-[100%] h-[100vh] relative duration-150 left-[2%] px-4 max-md:mt-10 scroll-mt-32 ${isSidebar && 'w-[50%] duration-150 ml-[20px]'} `}  id="discussionForm" >
